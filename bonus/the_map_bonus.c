...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/24 19:02:47 by alaktari          #+#    #+#             */
/*   Updated: 2024/06/02 13:44:22 by alaktari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**read_file(char *file, int lines, int i, int fd)
{
	char	**strs;
...
void	put_in_map(t_map ***map, t_list *list, int i)
{
	int		x;
	t_list	*head;
